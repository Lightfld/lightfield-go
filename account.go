...
// Moves an account to the trash. The account is soft-deleted and may be restored
// from the Lightfield UI. Associated contacts, tasks, and notes are not deleted;
// manage their lifecycle via their own endpoints.
//
// Calling delete on an already-trashed account is a no-op and returns the existing
// record.
//
// **[Required scope](/using-the-api/scopes/):** `accounts:delete`
//
// **[Rate limit category](/using-the-api/rate-limits/):** Write
func (r *AccountService) Delete(ctx context.Context, id string, body AccountDeleteParams, opts ...option.RequestOption) (res *AccountDeleteResponse, err error) {
	opts = slices.Concat(r.Options, opts)
	if id == "" {
		err = errors.New("missing required id parameter")
		return nil, err
...
type AccountDeleteResponse struct {
	...
	// Map of field names to their typed values. System fields are prefixed with `$`
	// (e.g. `$name`, `$email`); custom attributes use their bare slug.
	Fields map[string]AccountDeleteResponseField `json:"fields" api:"required"`
	// URL to view the entity in the Lightfield web app, or null.
	HTTPLink string `json:"httpLink" api:"required"`
	// Map of relationship names to their associated entities. System relationships are
	// prefixed with `$` (e.g. `$owner`, `$contact`).
	Relationships map[string]AccountDeleteResponseRelationship `json:"relationships" api:"required"`
	// ISO 8601 timestamp of when the entity was last updated, or null.
	UpdatedAt string `json:"updatedAt" api:"required"`
	// External identifier for the entity, or null if unset.
	ExternalID string `json:"externalId" api:"nullable"`
...
// Returns the unmodified JSON received from the API
func (r AccountDeleteResponse) RawJSON() string { return r.JSON.raw }
func (r *AccountDeleteResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type AccountDeleteResponseField struct {
	// The field value, or null if unset.
	Value AccountDeleteResponseFieldValueUnion `json:"value" api:"required"`
	// The data type of the field.
	//
	// Any of "ADDRESS", "CHECKBOX", "CURRENCY", "DATETIME", "EMAIL", "FULL_NAME",
	// "MARKDOWN", "MULTI_SELECT", "NUMBER", "SINGLE_SELECT", "SOCIAL_HANDLE",
...
// Returns the unmodified JSON received from the API
func (r AccountDeleteResponseField) RawJSON() string { return r.JSON.raw }
func (r *AccountDeleteResponseField) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// AccountDeleteResponseFieldValueUnion contains all possible properties and values
// from [string], [float64], [bool], [[]string],
// [AccountDeleteResponseFieldValueAddress],
// [AccountDeleteResponseFieldValueFullName].
//
// Use the methods beginning with 'As' to cast the union to one of its variants.
//
// If the underlying value is not a json object, one of the following properties
// will be valid: OfString OfFloat OfBool OfStringArray]
type AccountDeleteResponseFieldValueUnion struct {
	// This field will be present if the value is a [string] instead of an object.
	OfString string `json:",inline"`
	// This field will be present if the value is a [float64] instead of an object.
	OfFloat float64 `json:",inline"`
	...
	// This field will be present if the value is a [[]string] instead of an object.
	OfStringArray []string `json:",inline"`
	// This field is from variant [AccountDeleteResponseFieldValueAddress].
	City string `json:"city"`
	// This field is from variant [AccountDeleteResponseFieldValueAddress].
	Country string `json:"country"`
	// This field is from variant [AccountDeleteResponseFieldValueAddress].
	...
	// This field is from variant [AccountDeleteResponseFieldValueAddress].
	Street2 string `json:"street2"`
	// This field is from variant [AccountDeleteResponseFieldValueFullName].
	FirstName string `json:"firstName"`
	// This field is from variant [AccountDeleteResponseFieldValueFullName].
	LastName string `json:"lastName"`
	JSON     struct {
...
func (u AccountDeleteResponseFieldValueUnion) AsString() (v string) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

func (u AccountDeleteResponseFieldValueUnion) AsFloat() (v float64) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

func (u AccountDeleteResponseFieldValueUnion) AsBool() (v bool) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

func (u AccountDeleteResponseFieldValueUnion) AsStringArray() (v []string) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

func (u AccountDeleteResponseFieldValueUnion) AsAddress() (v AccountDeleteResponseFieldValueAddress) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

func (u AccountDeleteResponseFieldValueUnion) AsFullName() (v AccountDeleteResponseFieldValueFullName) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}

// Returns the unmodified JSON received from the API
func (u AccountDeleteResponseFieldValueUnion) RawJSON() string { return u.JSON.raw }

func (r *AccountDeleteResponseFieldValueUnion) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// Returns the unmodified JSON received from the API
func (r AccountDeleteResponseFieldValueAddress) RawJSON() string { return r.JSON.raw }
func (r *AccountDeleteResponseFieldValueAddress) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// Returns the unmodified JSON received from the API
func (r AccountDeleteResponseFieldValueFullName) RawJSON() string { return r.JSON.raw }
func (r *AccountDeleteResponseFieldValueFullName) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type AccountDeleteResponseRelationship struct {
	// Whether the relationship is `has_one` or `has_many`.
	Cardinality string `json:"cardinality" api:"required"`
	// The type of the related object (e.g. `account`, `contact`).
	ObjectType string `json:"objectType" api:"required"`
...
func (r *AccountDeleteParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type AccountDeleteParamsBody struct {
	paramObj
}

func (r AccountDeleteParamsBody) MarshalJSON() (data []byte, err error) {
	type shadow AccountDeleteParamsBody
	return param.MarshalObject(r, (*shadow)(&r))
}
