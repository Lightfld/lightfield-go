...
## [0.11.0](https://github.com/Lightfld/lightfield-go/compare/v0.10.0...v0.11.0) (2026-09-17)


### Features

* **api:** add field value history ([93f88d1](https://github.com/Lightfld/lightfield-go/commit/93f88d106dd04d36cc9c78a1cc2583b5250a94e6))


### Bug Fixes

* **api:** surface pipeline write rules in API references ([4956026](https://github.com/Lightfld/lightfield-go/commit/4956026d61d4b559000ec2824e68ad0b6d4300ba))
...
* **api:** manual updates to test custom objects ([677ed2d](https://github.com/Lightfld/lightfield-go/commit/677ed2d21fa3bb28e83c3970de1c78f2463cd216))
...
* **api:** release email API ([77d98e5](https://github.com/Lightfld/lightfield-go/commit/77d98e5db504a18e78ac09b34fb9d5c2eb764fb1))
...
* **api:** validate endpoint ([53abf6a](https://github.com/Lightfld/lightfield-go/commit/53abf6a02e78ebeb61502733353c1eda89a63454))
* **client:** optimize json encoder for internal types ([2877940](https://github.com/Lightfld/lightfield-go/commit/2877940a94c20bed5d29221ab3902c1f6068e659))
* **go:** add default http client with timeout ([ef55ea1](https://github.com/Lightfld/lightfield-go/commit/ef55ea1c5031e2f697f726a4173b8af80a6b6e5a))
...
* support setting headers via env ([ea053af](https://github.com/Lightfld/lightfield-go/commit/ea053af182d19f57ec179fbe167f1da68b230b58))
...
* **go:** avoid panic when http.DefaultTransport is wrapped ([35c90d4](https://github.com/Lightfld/lightfield-go/commit/35c90d4c749f121f845ddfe4a8ca2bf1fd93371c))
...
* avoid embedding reflect.Type for dead code elimination ([b58aaa7](https://github.com/Lightfld/lightfield-go/commit/b58aaa7730ba8e38412cf321506d20ec8a677f94))
...
* **internal:** more robust bootstrap script ([3850c36](https://github.com/Lightfld/lightfield-go/commit/3850c3616a701bdb95089a9651efc2f838fa0bff))
...
* redact api-key headers in debug logs ([af4d12b](https://github.com/Lightfld/lightfield-go/commit/af4d12b2b1e0e349b561579caa8e80060f4782ef))
...
* **tests:** bump steady to v0.22.1 ([9347560](https://github.com/Lightfld/lightfield-go/commit/93475602bd81e5a5dbee761129101cb04e13edeb))
...
## 0.6.0-alpha (2026-04-18)

Full Changelog: [v0.5.0-alpha...v0.6.0-alpha](https://github.com/Lightfld/lightfield-go/compare/v0.5.0-alpha...v0.6.0-alpha)
...
Full Changelog: [v0.4.1-alpha...v0.5.0-alpha](https://github.com/Lightfld/lightfield-go/compare/v0.4.1-alpha...v0.5.0-alpha)
