...
func TestWebhookStatus(t *testing.T) {
	...
	_, err := client.Webhook.Status(context.TODO(), "runId")
	if err != nil {
...
func TestWebhookTriggerGet(t *testing.T) {
	...
	_, err := client.Webhook.TriggerGet(context.TODO(), "webhookId")
	if err != nil {
		var apierr *githubcomlightfldlightfieldgo.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestWebhookTriggerPost(t *testing.T) {
	...
	_, err := client.Webhook.TriggerPost(
		context.TODO(),
		"webhookId",
		githubcomlightfldlightfieldgo.WebhookTriggerPostParams{
			Body: map[string]githubcomlightfldlightfieldgo.WebhookTriggerPostParamsBodyUnion{
				"foo": {
