...
func TestTaskDeleteWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Task.Delete(
		context.TODO(),
		"id",
		githubcomlightfldlightfieldgo.TaskDeleteParams{
			Body: githubcomlightfldlightfieldgo.TaskDeleteParamsBody{},
		},
	)
	if err != nil {
		var apierr *githubcomlightfldlightfieldgo.Error
